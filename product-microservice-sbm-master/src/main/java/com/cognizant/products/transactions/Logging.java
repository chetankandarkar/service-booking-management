package com.cognizant.products.transactions;
...
public class Logging {
	...
	@Pointcut("within(com.cognizant.products.service..*)"
			+ " || within(com.cognizant.products.controller..*)"
			+ " || within(com.cognizant.products..*)")
