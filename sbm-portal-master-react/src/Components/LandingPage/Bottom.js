...
export default function Bottom(props) {
  return (
    <>
      <footer className="text-secondary text-muted mt-5">
        <section className="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
          <div className="ml-5 d-none d-lg-block text-center text-secondary text-md-left">
        ...
        <Container className="py-4">
          <Row>
            <div className="col-md text-center text-secondary text-md-left">
              <h6 className="text-uppercase fw-bold mb-4">helper.me</h6>
              <p>
        ...
        <div className="text-center bg-danger p-3" style={{ color: "#F0EDEE" }}>
          © Designed by
          <a
